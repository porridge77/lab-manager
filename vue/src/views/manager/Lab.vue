  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="equipmentNum" label="设备数" show-overflow-tooltip></el-table-column>
        <el-table-column prop="adminName" label="实验室管理员"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="equipmentNum" label="设备数">
          <el-input v-model="form.equipmentNum" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="adminId" label="选择管理员">
          <el-select v-model="form.adminId" placeholder="请选择实验室管理员" style="width: 100%">
