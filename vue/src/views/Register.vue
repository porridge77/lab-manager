    ...
    <div style="width: 400px; padding: 30px; background-color: white; border-radius: 5px;">
      ...
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="name">
          <el-input prefix-icon="el-icon-s-custom" placeholder="请输入姓名" v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item prop="major">
          <el-input prefix-icon="el-icon-notebook-1" placeholder="请输入专业" v-model="form.major"></el-input>
        </el-form-item>
        <el-form-item prop="className">
          <el-input prefix-icon="el-icon-notebook-2" placeholder="请输入班级" v-model="form.className"></el-input>
        </el-form-item>
        <el-form-item>
